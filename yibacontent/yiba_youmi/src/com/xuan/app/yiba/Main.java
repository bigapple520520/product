...
public class Main extends Activity {
    ...
    private void initYouMi() {
        // 发布ID，密钥，调试模式
        AdManager.getInstance(Main.this).init("23a727717cb74a5b", "62a3e6960adbca32", false);

        // 底部广告
        LinearLayout adLayout = (LinearLayout) aboveView.findViewById(R.id.adLayout);
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                AdManager.getInstance(Main.this).setUserDataCollect(true);
            }
        }).start();
    }
