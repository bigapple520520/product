...
public class DoodleMain extends BasicActivity {
    private static final int REQUEST_OPERATE_TRANSLUCENT_ACTIVITY = 1;

    // @InjectView(R.id.tuYaPicView)
    private DoodleLineView doodleLineView;// 涂鸦的view
    ...
    private void initWidgits() {
        picBtn.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(DoodleMain.this, OperateTranslucentActivity.class);
        ...
        saveBtn.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // view截图
                CutViewUtils.cutView(getWindow().getDecorView(), Constants.PIC_STORE_PATH + "test.jpg");
            }
        });
    }
    ...
    private void refreshColorBtn(ImageButton curImageBtn, int colorResid) {
        ...
        // 切换画笔
        doodleLineView.initPaint(getResources().getColor(colorResid), doodleLineView.getPaint().getStrokeWidth());
    }
    ...
    private void refreshSizeBtn(PointView curPointView, int penSize) {
        ...
        // 切换画笔
        doodleLineView.initPaint(doodleLineView.getPaint().getColor(), penSize);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (REQUEST_OPERATE_TRANSLUCENT_ACTIVITY == requestCode) {
                ...
                doodleLineView.initBgPicBitmap(ImageUtils.decodeSampledBitmapFromFile(fileName,
                        doodleLineView.getWidth(), doodleLineView.getHeight()));
            }
        }
