...
<body>
  <div id="menu">
    <h3 id="menu_title"><a href="../" target="_blank"><?php echo htmlspecialchars($mc_config['site_name']); ?></a></h3>
    <ul>
      <li <?php echo $page_file == 'post.php' || $page_file == 'post-edit.php' ? 'class="current"' : ''; ?>><a href="post.php">文章</a></li>
      <li <?php echo $page_file == 'page.php' || $page_file == 'page-edit.php' ? 'class="current"' : ''; ?>><a href="page.php">关于我</a></li>
      <li <?php echo $page_file == 'conf.php' ? 'class="current"' : ''; ?>><a href="conf.php">网站参数设置</a></li>
    </ul>
    <div class="clear"></div>
  </div>
  <div id="content">
