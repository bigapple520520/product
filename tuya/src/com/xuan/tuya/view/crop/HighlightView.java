...
public class HighlightView {
    ...
    public int getHit(float x, float y) {
        ...
        if (mCircle) {
            ...
            // Log.v(TAG, "radius: " + radius + "; touchRadius: " + distanceFromCenter + "; distX: " + distX +
            // "; distY: " + distY + "; retval: " + retval);
        }
        else {
    ...
    public void setup(Matrix m, Rect imageRect, RectF cropRect, boolean circle, boolean maintainAspectRatio) {
        if (isDebug) {
            Log.v(TAG, "setup... " + imageRect + "; " + cropRect + "; maintain " + maintainAspectRatio + "; circle "
                    + circle);
        }
        if (circle) {
    ...
    public void modify(int keyCode, long repeatCount) {
        ...
        float widthUnits = factor * mContext.getWidth();
