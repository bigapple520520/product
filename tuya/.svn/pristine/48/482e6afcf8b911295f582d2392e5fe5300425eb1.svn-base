...
abstract public class ImageViewTouchBase extends ImageView {
    ...
    public void setImageBitmapResetBase(final Bitmap bitmap, final boolean resetSupp, final boolean isThumb) {
        ...
        if (bitmap != null) {
            if (!usePerfectFitBitmap()) {
                ...
                if ((mPerfectFitBitmap == null) || mPerfectFitBitmap.getWidth() != mThisWidth
                ...
                if (widthScale > heightScale) {
                    translateX = (int) ((viewWidth - bw * heightScale) * 0.5f);
                    translateY = (int) ((viewHeight - bh * heightScale) * 0.5f);
                }
                else {
                    translateX = (int) ((viewWidth - bw * widthScale) * 0.5f);
                    translateY = (int) ((viewHeight - bh * widthScale) * 0.5f);
                }

                android.graphics.Rect src = new android.graphics.Rect(0, 0, bw, bh);
                android.graphics.Rect dst = new android.graphics.Rect(translateX, translateY, mThisWidth - translateX,
                        mThisHeight - translateY);
    ...
    private String describe(Bitmap b) {
        ...
        if (b == null) {
            ...
            sb.append(String.format("%d x %d (size == %d)", b.getWidth(), b.getHeight(), b.getWidth() * b.getHeight()
                    * 2));
        }
        return sb.toString();
    }
